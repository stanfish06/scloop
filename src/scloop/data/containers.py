...
class HomologyData:
    ...
    def _assess_bootstrap_homology_equivalence(
        ...
        n_hubs_relaxation: Count_t = DEFAULT_N_HUBS_RELAXATION_EQUIVALENCE,
        max_n_edges_relaxation: Count_t = DEFAULT_MAX_N_EDGES_RELAXATION_EQUIVALENCE,
    ...
    def _test_loops(
        ...
        match presence_test_method:
            ...
            case "wilcoxon":
                self.bootstrap_data.presence_test_result = (
                    self.bootstrap_data.wilcoxon_test_presence(
                        method_pval_correction=method_pval_correction
                    )
                )
